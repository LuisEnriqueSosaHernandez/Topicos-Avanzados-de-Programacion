...
Random rnd = new Random();
    ...
    public Pacman() {
        ...
        comidax=(int)(rnd.nextDouble() * (getHeight()-80) + 0); 
        comiday=(int)(rnd.nextDouble() * (getWidth()+30)+ 0);
        rival1x=(int)(rnd.nextDouble() * (getHeight()-80) + 0); 
        rival1y=(int)(rnd.nextDouble() * (getWidth()+30)+ 0);
        rival2x=(int)(rnd.nextDouble() * (getHeight()-80) + 0); 
        rival2y=(int)(rnd.nextDouble() * (getWidth()+30)+ 0);
