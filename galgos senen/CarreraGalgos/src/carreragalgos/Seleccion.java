...
public class Seleccion extends JFrame implements ActionListener{
    ...
    public static String vuelta;//Estatica por que yolo uvu , jaja para poder usarla en el otro laredo
    public Galgodromo gal;
...
//    conv = Integer.parseInt(conver);
   ...
   //Orientando los objetos
    ...
    this.setTitle("Carreras hilos nivel 1");
