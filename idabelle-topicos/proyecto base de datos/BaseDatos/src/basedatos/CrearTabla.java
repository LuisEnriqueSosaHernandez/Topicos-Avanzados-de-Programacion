...
public class CrearTabla extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        CTnbd = new javax.swing.JTextField();
        jButton1 = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setTitle("Generar Tablas");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(105, 105, 105)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(CTnbd, javax.swing.GroupLayout.DEFAULT_SIZE, 26, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       SQL db=new SQL();
       if(CTnbd.getText().isEmpty()){
           JOptionPane.showMessageDialog(null, "Ingresa Nombre de la tabla.");
       }else{
           db.createTable(CTnbd.getText());
           dispose();
       }
    ...
    private javax.swing.JTextField CTnbd;
