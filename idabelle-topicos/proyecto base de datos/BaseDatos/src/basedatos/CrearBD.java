...
public class CrearBD extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        CRnbd = new javax.swing.JTextField();
        jButton1 = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setTitle("Generar Base de Datos.");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(96, 96, 96)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(CRnbd, javax.swing.GroupLayout.DEFAULT_SIZE, 33, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        SQL db=new SQL();
        if(CRnbd.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "Ingresa Nombre base de datos");
       }else{        
           try {                
               db.createDB(CRnbd.getText());
               dispose();
           } catch (Exception ex) {
    ...
    private javax.swing.JTextField CRnbd;
